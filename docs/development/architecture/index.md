...
Das zentrale Element unserer Anwendung bildet die **[UI](architecture/ui)** - unsere Vue.js-Webanwendung von hfg.design 2.0. Sie stellt eine einheitliche Benutzeroberfläche für alle Systemfunktionen bereit und integriert seamless verschiedene Arbeitsräume (Spaces) mit unterschiedlichen Capabilities.

Die **[API](architecture/api)** fungiert als zentraler Vermittler und verwaltet alle persistenten Daten über eine RESTful-Schnittstelle. Sie koordiniert die Kommunikation zwischen allen Services und bietet Real-time-Updates über Socket.io.

## Core Services

### Datenhaltung & Storage

**[MongoDB](architecture/mongodb)** - Unsere zentrale NoSQL-Datenbank speichert alle Anwendungsdaten:
...
**[MinIO](architecture/minio)** - S3-kompatibles Object Storage für Mediendateien:
...
**[Matrix Synapse](architecture/synapse)** - Unser Chat-Backend ermöglicht:
...
**[LiveKit](architecture/livekit)** - WebRTC-Plattform für Live-Übertragungen:
...
**[Keycloak](architecture/keycloak)** - Zentrales Identity & Access Management:
...
**[AI-Agents](architecture/ai)** - Spezialisierte Agents für automatisierte Stream-Analyse:
