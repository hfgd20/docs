...
**[MongoDB](backend-services#mongodb)** - Unsere zentrale NoSQL-Datenbank speichert alle Anwendungsdaten:
...
**[MinIO](backend-services#minio)** - S3-kompatibles Object Storage für Mediendateien:
...
**[LiveKit](backend-services#livekit)** - WebRTC-Plattform für Live-Übertragungen:
...
**[Keycloak](backend-services#keycloak)** - Zentrales Identity & Access Management:
